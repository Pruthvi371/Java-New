...
public class DateTimeDemo {
	...
	public static void main(String[] args) {
		// testLegacyDateAPI();
		testDateTimeAPI();
//		LocalDateTime gameStartTime = LocalDateTime.of(2017, 12, 20, 9, 0);
//		System.out.println("gameStartTime: " + gameStartTime);
//
//		// TimeZone ==> ZoneId
//		ZonedDateTime zonedGameStartTime = ZonedDateTime.of(gameStartTime, ZoneId.of("America/Los_Angeles"));
//		System.out.println("zonedGameStartTime: " + zonedGameStartTime);
//		
//		ZonedDateTime indiaTime = zonedGameStartTime.withZoneSameInstant(ZoneId.of("Asia/Dubai"));
//		System.out.println("indiaTime: " + indiaTime);
	}
}
